...
module.exports = function makeWebpackConfig(options) {
    ...
    config.module = {
        rules: [{
            ...
            //https://stackoverflow.com/questions/41658289/how-to-solve-module-id-should-be-a-string-error-using-webpack2?answertab=active#tab-top
            test: /.*node_modules\/jw-angular-pagination\/.*\.js/,
